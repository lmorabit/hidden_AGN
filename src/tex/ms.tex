...
\begin{figure}
    \centering
    \includegraphics[width=0.48\textwidth]{figures/test.png}
    \caption{Caption}
    \label{fig:test}
    \script{testplot.py}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.48\textwidth]{figures/completeness.png}
    \caption{Caption}
...
\begin{figure*}
    \centering
    \includegraphics[width=0.98\textwidth]{figures/mauch_sadler_RLFs.png}
    \caption{Caption}
    \label{fig:msrlfs}
